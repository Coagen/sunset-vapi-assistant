  ...
  return (
    <>
      ...
      {activeWidget !== 'elevenlabs' && (
        <button
          onClick={toggleMenu}
          className={`fixed bottom-6 right-6 z-[100] p-4 rounded-full shadow-xl hover:scale-105 transition-all duration-200 border-2 border-brand-gold/50 ${isOpen ? 'bg-brand-gold text-white' : 'bg-brand-navy text-white'}`}
